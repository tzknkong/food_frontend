<template>
  <section class="sign">
    <header class="header">
      <a href="/">
        <span class="text">Food Home</span>
      </a>
    </header>
    <main class="main background">
      <div class="inner">
        ...
        <div class="form" v-if="type === 'signin'">
          ...
          <div class="form-item">
            <input type="text" name="email" placeholder="**@food.com" v-model="signin.email">
        ...
        <div class="form" v-if="type === 'signup'">
          <label for="email">Email Address</label>
          <div class="form-item">
            <input type="text" name="email" placeholder="**@food.com" v-model="signup.email">
            <i class="fa fa-envelope-o"></i>
          </div>
    ...
    <footer class="footer">
      <div class="inner">
        <span>© 2019 Food , All Rights Reserved.</span>
      </div>
    </footer>
  </section>
</template>
